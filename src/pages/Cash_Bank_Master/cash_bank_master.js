...
//    }, []);
       ...
       <div className="container-common">
         <div className="card">
           <div className="card-header-css">
             <h3>Cash/Bank Master</h3>
           </div>
           <div className="card-body">
           
             {/*  ****************************************************************************
                                    Account Type and Account Title
             **************************************************************************** */}
             <div className="row ">
                 <div className="col-md-6 mb-2 d-flex">
                         <label htmlFor="acctType" className="form-label label-width label-color-common">Account Type</label>
                         <select id="acctType" className="form-select size_input_contra" name='acctType' value={acctType}
                             onChange={(e) => handleCashBankDebit(e.target.value)}>
                                 <option value=" ">Select Account Type</option>
                         </select> 
                 </div>
                 <div className="col-md-6 mb-2 d-flex">
                         <label htmlFor="acctTitle" className="form-label label-width label-color-common">Account Title</label>
                         <input id="acctTitle" type="text" className="form-control form-control-ce size_input_contra"
 ...
 export default Cash_Bank_Master;
