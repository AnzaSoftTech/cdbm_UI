...
function Contra_Entry() {
    ...
    useEffect(() => {
        axios.get('http://localhost:3001/analyzercode')
    ...
    const handleCashBankDebit = async (p_actDrCode) => {
        ...
        const response = await axios.get(`http://localhost:3001/populatedetails?p_cb_act_cd=` + p_actDrCode);
    ...
    const handleFinalSave = () => {
        ...
        axios.post('http://localhost:3001/savevoucher', data)
                .then(response => {
      ...
      <div className="container">
        <div className="card">
          <div className="card-header-css">
            <h3 className="text-center">Contra Entry </h3>
          </div>
          <div className="card-body">
            ...
            **************************************************************************** */}
            <div className="row ">
                <div className="col-md-6 mb-3 d-flex">
                        <label htmlFor="cbaccountDr" className="form-label label-width">Cash/Bank Dr</label>
                ...
                <div className="col-md-6 mb-3 d-flex">
                        <label htmlFor="cbaccountCr" className="form-label label-width">Cash/Bank Cr</label>
            ...
            **************************************************************************** */}
            <div className="row ">
                <div className="col-md-6 mb-3 d-flex">
                        <label htmlFor="dranalyzerCode" className="form-label label-width">Analyzer Dr</label>
                ...
                <div className="col-md-6 mb-3 d-flex">
                        <label htmlFor="cranalyzerCode" className="form-label label-width">Analyzer Cr</label>
            ...
            **************************************************************************** */}
            <div className="row ">
                <div className="col-md-6 mb-3 d-flex">
                    <label htmlFor="amount" className="form-label label-width">Amount</label>
                    <input id="amount" type="number" className="form-control size_input_contra " value={amount} onChange={(e) => setAmount(e.target.value)}  />
                </div>
                <div className="col-md-6 mb-3 d-flex">
                    <label htmlFor="narration" className="form-label label-width ">Narration </label>
                    <input id="narration" type="text" className="form-control size_input_contra" value={narration} onChange={(e) => setNarration(e.target.value)} />
                </div>
            </div>
            {/*  ****************************************************************************
            ...
            **************************************************************************** */}
            <div className="row ">
                ...
                <div className="col-md-6 mb-3 d-flex">
                    <label htmlFor="voucherDate" className="form-label label-width ">Voucher Date </label>
                    <input id="voucherDate" type="date" className="form-control size_input_contra" style={{ marginLeft: '0px'}}
            ...
            **************************************************************************** */}
            <div className="row ">
                <div className="col-md-6 mb-3 d-flex">
                    ...
                    <input id="voucherNo" type="number" className="form-control size_input_contra " value={voucherNo} onChange={(e) => setVoucherNo(e.target.value)} readOnly />
                </div>
                <div className="col-md-6 mb-3 d-flex">
                    <label htmlFor="effectiveDate" className="form-label label-width ">Effective Date </label>
                    <input id="effectiveDate" type="date" className="form-control size_input_contra" value={effectiveDate} onChange={(e) => setEffectiveDate(e.target.value)} />
                </div>
            </div>
            ...
            **************************************************************************** */}
            <div className="row ">
                <div className="col-md-6 mb-3 d-flex  justify-content-end ">
                    <button className="btn  btn-primary me-2" >Edit Voucher</button>
