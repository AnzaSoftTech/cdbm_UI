...
export default function Bank_Details({ onCloseClick, p_actCode, p_actName, is_Auto }) {
    ...
    // const handleGetBankDetailsAddRow = () => {
    //     details.map((result, index) => {
    //         setBankDetails([...Bankdetails, {
    //             bank_name: result.bank_name, bank_acc_type: result.bank_acc_type, bank_acc_no: result.bank_acc_no
    //             , upi_id: result.upi_id, start_date: result.start_date, end_date: result.end_date, ifsc: result.ifsc
    //             , bank_address_1: result.bank_addr_1, bank_address_2: result.bank_addr_2, bank_address_3: result.bank_address_3
    //             , ac_status: result.status,
    //         }]);
    //     })
    // };
    ...
    return (
        ...
        <div className="popup_addr_cont" style={{height: '620px'}}>
            <div className="popup-inner">
                <div className='div_header_warn'>
                    <h4 className='search_header '>Bank Details</h4>
                </div>
        ...
        //         <button className="btn btn-success " onClick={handleBankDetailsAddRow}>Add</button>
        //     </div>
        //     <div>
