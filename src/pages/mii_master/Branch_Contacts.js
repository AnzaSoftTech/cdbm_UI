...
import './BranchPopupCss.css'; 
import { BASE_URL } from ".././constants";

function Branch_Contacts({ onCloseClick, p_mii_Code, p_Address_Id, p_BankShortName }) {
  ...
  //  const [totalBalanceQty, setTotalBalanceQty] = useState(0);
    ...
    const [addrtype, setAddrType] = useState('MII_MASTER');
    ...
    const handleFinalSave = () => {
        ...
        .then(response => {
            ...
            alert('Branch and Contact Persons saved successfully!')});
    ...
    const handleGetAddresses = async () => {
        ...
        try {
            const response = await axios.get(`${BASE_URL}/api/get_addresses`, {
                params: {
                    p_addr_type: addrtype || 'MII_MASTER',
                    p_act_Code: p_mii_Code
                }
            });
            setAddressResults(response.data);
           // console.log('response.data ==> ', response.data);
    ...
    return (
        <div className="popup_addr_cont b">
            <div className="popup-inner">
            <div className='div_header_warn'>
                    <h4 className='search_header '>MII Branch & Contact Persons</h4>
                </div>
                ...
                **************************************************************************************************** */}
                ...
                <div className='div_sub_header_warn'>
                    <h6 className='search_header '>Branch Address</h6>
                </div>
...
export default Branch_Contacts;
