...
function Address_Contacts({ onCloseClick, p_actCode, p_Address_Id, p_BankShortName }) {
    ...
    const handleGetAddresses = async () => {
        ...
        try {
            const response = await axios.get(`${BASE_URL}/api/get_addresses_vendor`, {
                params: {
    ...
    const handleFinalSave = () => {
        ...
        axios.post(`${BASE_URL}/api/save_address_cont_persons_vendor`, data)
            .then(response => {
